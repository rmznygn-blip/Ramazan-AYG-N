    ...
    fun evaluatePositionState(
        ...
        if (currentMarketPrice >= position.targetExitPriceWithProfit) {
            ...
            val signal = TradeSignalEntity(
                ...
                buyFeeRate = CommissionCalculator.EXCHANGE_FEE_RATES[position.exchange] ?: 0.0008,
                sellFeeRate = CommissionCalculator.EXCHANGE_FEE_RATES[position.exchange] ?: 0.0008,
